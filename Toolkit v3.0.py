        ...
        def generate_html_report(futures_df: pd.DataFrame, spot_df: pd.DataFrame) -> Optional[str]:
            ...
            <body>
                <div class="header">
                    ...
                    <small>Brought to you by: @heisbuba</small>
                    <p><small>Generated on: {current_time}</small></p>
                </div>
                {html_content}
                  {oiss_explainer_html}
                <div class="footer">
                    <p>Generated by Crypto Volume Analysis Toolkit 3.0 | By (@heisbuba)</p>
                </div>
            </body>
            </html>
            """
...
<body>
    <div class="container">
        ...
        <p style="text-align:center; color:#848e9c; font-size:0.9rem;">
            Crypto Volume Analysis Toolkit v3.0<br>By @heisbuba
        </p>
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <a href="https://medium.com/@heisbuba" class="btn btn-blue" target="_blank">Medium Blog</a>
            <div style="margin-top:15px; display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                ...
                <a href="https://facebook.com/heisbuba" class="btn-share btn-blue" style="margin:0;" target="_blank">Facebook</a>
                 <a href="https://youtube.com/@heisbuba25" class="btn-share btn-blue" style="margin:0;" target="_blank">YouTube</a>
